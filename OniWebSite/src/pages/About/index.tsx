      ...
      >
        ...
        >
          <Flex direction='column' style={{ width: isMobile ? 'auto' : 450 }}>
            ...
            {isMobile && (
              <Typography variant='body1' style={{ marginBottom: '2rem' }}>
                Моими учителями стали лучшие шефы мира Оливье Бажар, Патрик
                Казула, Гийом Мобиё, Ханс Овандо, Мишель Вийом. Это очень крутой
                опыт! Я увидела, как организована профессиональная кухня и
                поняла, над чем нужно работать ближайшие годы.
              </Typography>
            )}
          </Flex>
          <Flex
        ...
        >
          ...
          {!isMobile && (
            ...
            >
              Моими учителями стали лучшие шефы мира Оливье Бажар, Патрик
              Казула, Гийом Мобиё, Ханс Овандо, Мишель Вийом. Это очень крутой
              опыт! Я увидела, как организована профессиональная кухня и поняла,
              над чем нужно работать ближайшие годы.
            </Typography>
          )}
          <Typography
            variant='body1'
