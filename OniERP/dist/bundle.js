...
var MainPage = /** @class */function (_super) {
    ...
    MainPage.prototype.renderHistory = function () {
        ...
        return React.createElement(List_1.default, { component: "nav" }, history.map(function (h) {
            return React.createElement(ListItem_1.default, { button: true, key: h.id }, React.createElement(ListItemText_1.default, { inset: true, primary: "Check #" + h.id + ", desserts count: " + h.desserts.length + ", drinks count: " + h.drinks.length + ", pay by " + h.payment + ", ordered in " + h.type }));
        }));
    };
